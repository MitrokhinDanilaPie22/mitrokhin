		...
		<Container>
			<div className='flex flex-col items-center justify-center py-[96px]'>
				...
				<div className='flex space-x-4'>
					<a href='https://www.spotify.com/' target="_blank"><FaSpotify
						size={24}
						className='text-black cursor-pointer hover:scale-110 transition'
					/></a>
					<a href='https://soundcloud.com/' target="_blank"><FaSoundcloud
						size={24}
						className='text-black cursor-pointer hover:scale-110 transition'
					/></a>
					<a href='https://music.apple.com/' target="_blank"> <FaApple
						size={24}
						className='text-black cursor-pointer hover:scale-110 transition'
					/> </a>
				</div>
